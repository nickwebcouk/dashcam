...
# Pressure and Temprature
    ...
    print textaccxhelper
    print textaccyhelper
    print textcfaxhelper
    print textcfayhelper
    print textheadhelper
